  ...
  return (
    <>
      ...
      <div className="relative flex w-full flex-col md:hidden bg-[#F5EBE6] pt-24 pb-14 overflow-hidden min-h-[600px] min-[375px]:min-h-[640px] min-[410px]:min-h-[680px]">
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              onClick={onJoinBrand}
              className="h-10 w-full rounded-full border border-[#741717] bg-transparent text-xs tracking-wide text-[#741717] font-sans font-medium transition-all active:scale-[0.98]"
            >
              Join as a Brand
            </button>
            <button
              ...
              className="h-10 w-full rounded-full bg-[#741717] text-xs tracking-wide text-white font-sans font-medium transition-all active:scale-[0.98]"
            >
              Join as a Creator
            </button>
          </motion.div>
        ...
        {/* Mobile Right overlapping phone image */}
        <motion.div
      ...
      {/* DESKTOP HERO VIEW (Original design, shown only on screen sizes >= md) */}
      <section className="relative hidden md:flex h-svh min-h-[900px] max-h-[900px] w-full flex-col items-center bg-[#F1E8E8] pt-24 md:pt-32 lg:pt-35 overflow-hidden">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={{
        ...
        >
          ...
          >
            ...
            <br />
            where{" "}
            <span className="text-[#741717] font-medium">creators</span> and{" "}
            <span className="text-[#741717] font-medium">brands</span>
            <br />
